...
namespace SocialNetwork.Migrations
{
    ...
    [Migration("20210601232612_appuserv3")]
    partial class appuserv3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialNetwork.Models.UserInfo", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SocialNetwork.Models.Comment", b =>
                {
                    b.HasOne("SocialNetwork.Models.UserInfo", "UserInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("SocialNetwork.Models.Message", b =>
                {
                    b.HasOne("SocialNetwork.Models.UserInfo", "User")
                        .WithMany("Messages")
                        .HasForeignKey("userID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
