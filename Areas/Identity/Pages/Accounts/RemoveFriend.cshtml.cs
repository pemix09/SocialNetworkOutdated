...
namespace SocialNetwork.Areas.Identity.Pages.Accounts
{
    public class RemoveFriendModel : PageModel
    {
        ...
        public RemoveFriendModel(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, SocialNetworkContext context,
        ...
        public async Task<IActionResult> OnGet(string id)
        {
            ...
            await db.RemoveFriend(id, userID,_context);
